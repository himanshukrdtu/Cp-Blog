...
const AboutPage = () => {
                ...
                <Container>
                    <div className="max-w-3xl mx-auto text-center">
                        ...
                        <div className="mb-8">
                            ...
                            <p className="text-lg mb-4 text-justify">
                                My name is Himanshu Kumar, and I'm currently pursuing B-TECH at Delhi Technological University (formerly Delhi College of Engineering). As a pre-final year student, I have a passion for technology and web development.
                            </p>
                            <p className="text-lg mb-4 text-justify">
    ...
    <div className="max-w-3xl w-full">
        ...
        <ul className="flex justify-center space-x-4">
            <li>
                <a href="https://www.instagram.com/himanshu__singh__rajpoot/" className="flex items-center text-indigo-400 hover:text-indigo-300">
            ...
            <li>
                <a href="https://www.linkedin.com/in/himanshu-kumar-23993422a/" className="flex items-center text-indigo-400 hover:text-indigo-300">
            ...
            <li>
                <a href="https://github.com/himanshukrdtu" className="flex items-center text-indigo-400 hover:text-indigo-300">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="32" height="32" className="mr-2">
